...
import com.vpnapp.np.OneSignal.MyNotificationOpenedHandler;
import com.vpnapp.np.OneSignal.MyNotificationReceivedHandler;
...
public class MainApplication extends MultiDexApplication {
    ...
    public void initHydraSdk() {
        ...
        ClientInfo clientInfo = ClientInfo.newBuilder()
                ...
                .carrierId(prefs.getString(BuildConfig.STORED_CARRIER_ID_KEY, "afdemo"))
                .build();
